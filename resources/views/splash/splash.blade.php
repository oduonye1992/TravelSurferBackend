        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">SplashScreen</a>
                    </li>
                </ul>
                <!-- END BREADCRUMB -->
            </div>
        ...
        <div class="panel panel-transparent">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <div class="col-xs-12">
                        <button id="add-btn" class="btn btn-complete btn-cons"> Add a SplashScreen </button>
                    </div>
                </div>
                ...
                <table class="table table-hover demo-table-dynamic" id="tableWithDynamicRows">
                    ...
                    @foreach($splashes as $splash)
                        <tr>
                            ...
                            <td class="v-align-middle">
                                <p><img src="{{$splash['image']}}" width="100"/></p>
                            </td>
                            <td class="v-align-middle">
                                <p>{{$splash['backgroundColor']}}</p>
                            </td>
                            <td class="v-align-middle">
                                <p>{{$splash['fontColor']}}</p>
                            </td>
                            <td class="v-align-middle">
                                <p>{{$splash['level']}}</p>
                            </td>
                            ...
                            <td class="v-align-middle">
                                <div class="btn-group dropdown-default">
                                    ...
                                    <ul class="dropdown-menu" role="menu" style="width: 141px;">
                                        <li><a data-obj="{{json_encode($splash)}}" class="edit-btn" href="#">Edit SplashScreen</a>
                                        </li>
                                        <li><a href="#" data-id="{{$splash['id']}}" class="delete-btn btn-danger btn btn-cons">Delete Splashscreen</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
            ...
            <div class="modal-content-wrapper">
                <div class="modal-content">
                    <div class="modal-header clearfix text-left">
                        ...
                        <h5 style="text-align: center;">Add SplashScreen</h5>
                        <p class="p-b-10"></p>
                    </div>
                        ...
                        <form role="form">
                            <div class="form-group-attached">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            <label>Background Colour (Hex)</label>
                                            <input id="backgroundColor" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group form-group-default">
                                            <label>Font Colour (Hex)</label>
                                            <input id="fontColor" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
@section('javascript')
    ...
    <script>
        // Create
        var endpoint = "{{url('api/splash_screen')}}";
