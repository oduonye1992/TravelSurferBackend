        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Imagess</a>
                    </li>
                </ul>
                <!-- END BREADCRUMB -->
            </div>
    ...
    <div class="container-fluid container-fixed-lg">
        ...
        <div class="panel panel-transparent">
            <div class="panel-heading">
                <div class="panel-title">Hotel Images
                </div>
                <div class="pull-right">
                    <div class="col-xs-12">
                        <button id="add-btn" class="btn btn-complete btn-cons"> Add Image</button>
                    </div>
                </div>
                    ...
                    @foreach($images as $image)
                        <tr>
                            <td class="v-align-middle">
                                <p><img src="{{$image['image']}}" width="100"/></p>
                            </td>
                            <td class="v-align-middle">
                                <p>{{$image['image']}}</p>
                            </td>
                            <td class="v-align-middle">
                                <div class="btn-group dropdown-default">
                                    ...
                                    <ul class="dropdown-menu" role="menu" style="width: 141px;">
                                        <li><a data-obj="{{json_encode($image)}}" class="edit-btn" href="#">Edit Image</a>
                                        </li>
                                        <li><a href="#" data-id="{{$image['id']}}" class="delete-btn btn-danger btn btn-cons">Delete Image</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
