    ...
    <div class="container-fluid container-fixed-lg">
        ...
        <div class="panel panel-transparent">
            <div class="panel-heading">
                <div class="panel-title">List of Countries
                </div>
                <div class="pull-right">
                    <div class="col-xs-12">
                        <button id="add-btn" class="btn btn-complete btn-cons"> Add a Country</button>
                    </div>
                </div>
                            ...
                            <td class="v-align-middle">
                                <div class="btn-group dropdown-default">
                                    ...
                                    <ul class="dropdown-menu" role="menu" style="width: 141px;">
                                        <li><a data-obj="{{json_encode($country)}}" class="edit-btn" href="#">Edit</a>
                                        </li>
                                        <li><a href="#" data-id="{{$country['id']}}" class="delete-btn btn-danger btn btn-cons">Delete</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
            ...
            <div class="modal-content-wrapper">
                <div class="modal-content">
                    <div class="modal-header clearfix text-left">
                        ...
                        <h5 style="text-align: center;">Add Country</h5>
                        <p class="p-b-10"></p>
                    </div>
